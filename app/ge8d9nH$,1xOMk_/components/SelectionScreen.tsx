...
export default function SelectionScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-300 via-sky-200 to-blue-100 dark:from-sky-900 dark:to-blue-800 flex flex-col lg:flex-row">
      {/* Left Button - Crypto Dashboard */}
      <button
        onClick={onSelectCrypto}
        className="flex-1 min-h-[50vh] lg:min-h-screen group relative overflow-hidden transition-all hover:flex-[1.05] focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-inset"
      >
        {/* Gradient Overlay */}
        ...
        {/* Border on the right (desktop) or bottom (mobile) */}
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-8 text-center">
          ...
          {/* Title */}
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-sky-50 mb-4 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors">
            Crypto Dashboard
          </h2>
      ...
      {/* Right Button - TODO Manager */}
      <button
        onClick={onSelectTodos}
        className="flex-1 min-h-[50vh] lg:min-h-screen group relative overflow-hidden transition-all hover:flex-[1.05] focus:outline-none focus:ring-4 focus:ring-sky-500 focus:ring-inset"
      >
        {/* Gradient Overlay */}
        ...
        <div className="relative h-full flex flex-col items-center justify-center p-8 text-center">
          ...
          {/* Title */}
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-sky-50 mb-4 group-hover:text-sky-700 dark:group-hover:text-sky-300 transition-colors">
            TODO Manager
          </h2>
